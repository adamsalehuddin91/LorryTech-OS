...
export default function Edit({ expense, vehicles, drivers, categories }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        receipt_date: expense.receipt_date?.split('T')[0] || expense.receipt_date || '',
        description: expense.description || '',
        receipt_image: null,
    });

    const [preview, setPreview] = useState(expense.receipt_image_url || null);
                                ...
                                <div className="mt-1 flex items-center gap-4">
                                    <label className="cursor-pointer inline-flex items-center rounded-lg border-2 border-dashed border-gray-300 px-6 py-4 hover:border-blue-400 hover:bg-blue-50 transition-colors">
                                        <div className="text-center">
                                            ...
                                            <p className="mt-1 text-xs text-gray-500">
                                                {preview ? 'Tukar gambar' : 'Klik untuk muat naik'}
                                            </p>
                                    ...
                                    {preview && (
                                        <div className="relative">
                                            <img src={preview} alt="Receipt" className="h-24 w-24 rounded-lg object-cover border border-gray-200" />
                                        </div>
                                    )}
                                </div>
