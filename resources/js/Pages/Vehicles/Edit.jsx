                            ...
                            <div>
                                ...
                                <div className="flex items-start gap-4">
                                    {preview ? (
                                        ...
                                        <img src={vehicle.photo} alt="Gambar sedia ada" className="w-32 h-24 object-cover rounded-xl border border-gray-200 flex-shrink-0" />
                                    ) : (
                                    ...
                                    <div>
                                        <label className="cursor-pointer inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">
                                            ...
                                            {vehicle.photo ? 'Tukar Gambar' : 'Pilih Gambar'}
