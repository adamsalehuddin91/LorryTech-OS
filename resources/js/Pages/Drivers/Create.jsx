...
export default function Create() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('drivers.store'), { forceFormData: true });
    };
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                                    ...
                                    {preview ? (
                                        <div className="relative w-24 h-24 flex-shrink-0">
                                            ...
                                            <button type="button" onClick={() => { setData('photo', null); setPreview(null); }}
                                                className="absolute -top-1 -right-1 w-6 h-6 bg-red-500 text-white rounded-full text-sm flex items-center justify-center shadow">×</button>
                                        </div>
                                    ) : (
                                        <div className="w-24 h-24 rounded-full border-2 border-dashed border-gray-300 flex items-center justify-center flex-shrink-0 bg-gray-50 text-3xl">👤</div>
                                    )}
                                    <div className="pt-2">
                            ...
                            <div className="pt-4 border-t border-gray-200">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">
                                            Gaji Pokok (RM/bulan) <span className="text-gray-400 font-normal">— pilihan</span>
                                        </label>
                                        <input
                                            type="number"
                                            step="0.01"
                                        ...
                                        />
                                        <p className="mt-1 text-xs text-gray-500">
                                            Biar kosong kalau pemandu makan gaji harian sepenuhnya. Kalau diisi, ia
                                            ditambah DI ATAS gaji harian dan muncul sebagai baris berasingan pada slip.
                                        </p>
